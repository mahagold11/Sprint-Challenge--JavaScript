...
lowCaseAnimalNames = zooAnimals.map(animals => animals.animal_name.toLowerCase())
...
lowPopulationAnimals = zooAnimals.filter(animals => animals.population < 5)
...
populationTotal = zooAnimals.population.reduce((a,b) => a + b, 0);
